...
# Exclude only the HAL-Next based retarget_io helper. It requires mtb_hal.h /
# mtb_syspm_callbacks.h which are not available for this classic-HAL PSoC6 BSP.
# The profiler module (common_modules/profiler.c) is kept in the build.
CY_IGNORE+=common_modules/retarget_io
